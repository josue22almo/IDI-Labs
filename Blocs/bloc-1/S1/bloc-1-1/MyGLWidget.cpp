...
void MyGLWidget::createBuffers ()
{
  ...
  Vertices[6] = glm::vec3(0.0, 0.5, 0.0); 
  Vertices[7] = glm::vec3(0.5, 0.5, 0.0);
  Vertices[8] = glm::vec3(0.25, 0.75, 0.0);
  ...
  Vertices1[1] = glm::vec3(-0.5, 0.0, 0.0);
  Vertices1[2] = glm::vec3(0.0, -0.5, 0.0);
  
  Vertices1[3] = glm::vec3(0.0, -0.5, 0.0); 
  Vertices1[4] = glm::vec3(-0.5, -0.5, 0.0);
  Vertices1[5] = glm::vec3(-0.5, 0.0, 0.0);
  
  
  // Creació del Vertex Array Object (VAO1) que usarem per pintar
